...
############################################################################
# Operators: Sel: DoubleTournament, Crossover: OnePoint, Mutation: Uniform
############################################################################

selstr = "doubletournament"
cxstr = "onepoint"
mutstr = "uniform"
...
pset.addEphemeralConstant("R", lambda: round(numpy.random.uniform(low=-1, high=1), 2)) #Ephemeral constant -> random number between -1 and 1
